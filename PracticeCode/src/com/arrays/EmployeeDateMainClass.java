...
class Employee {
	...
	public Employee(int eid, String ename, double salary, Date date) {
		super();
		this.eid = eid;
		this.ename = ename;
		this.salary = salary;
	...
	@Override
	public String toString() {
		return "Employee [eid=" + eid + ", ename=" + ename + ", salary=" + salary + ", date=" + date + "]";
	}

}

public class EmployeeDateMainClass {
